...
|------|----------|---------|
| `ChrisCustomFLC-MultiOS-0.4.0-linux.deb` | Linux (Debian/Ubuntu/Mint) | Double-click, or `sudo apt install ./ChrisCustomFLC-MultiOS-0.4.0-linux.deb` |
| `ChrisCustomFLC-MultiOS-0.4.0-linux.AppImage` | Linux (portable) | `chmod +x ChrisCustomFLC-MultiOS-0.4.0-linux.AppImage` then run |
