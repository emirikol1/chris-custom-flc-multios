...
|------|----------|---------|
| `ChrisCustomFLC-MultiOS-0.2.1-linux.deb` | Linux (Debian/Ubuntu/Mint) | Double-click, or `sudo apt install ./ChrisCustomFLC-MultiOS-0.2.1-linux.deb` |
| `ChrisCustomFLC-MultiOS-0.2.1-linux.AppImage` | Linux (portable) | `chmod +x ChrisCustomFLC-MultiOS-0.2.1-linux.AppImage` then run |
